				...
				<div className="bg-foreground/5 relative container space-y-4 py-9">
					<div className="grid w-full gap-4 max-md:grid-cols-2">
						<div className="space-y-4">
							...
							<Separator />
							<p
								className="font-display text-3xl leading-tight text-[#37D787] md:hidden"
								itemProp="name"
							>
								Shashi S. Piptan
							</p>
					...
					<p className="font-display relative z-10 leading-tight text-[#37D787] md:text-3xl lg:text-4xl">
